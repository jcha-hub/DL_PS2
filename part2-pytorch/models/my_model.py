...
class MyModel(nn.Module):
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(128,160,3, 1, padding='same')
        self.conv5 = nn.Conv2d(160, 192, 3, 1, padding='same')
        self.conv6 = nn.Conv2d(192, 224, 3, 1, padding=0)
        self.pool = nn.MaxPool2d(2, 2)
        self.fc1 = nn.Linear(in_features = 896, out_features = 500)
    ...
    def forward(self, x):
        ...
        # print('fc_in_features', fc_in_features)       #896

        x = torch.flatten(x, 1)
        x = F.relu(self.fc1(x))
        x = F.dropout(x, 0.5)   #reduce overfitting
